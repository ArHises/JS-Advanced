...
// "super-dropdown", необходимо использовать методы forEach и querySelectorAll и свойство classList у элементов.

const dropdownArray = document.querySelectorAll(".dropdown-item");
...
// []()
// 5. У элемента с id "dropdownMenuButton" замените id
// на "superDropdown".
...
// []()
// 6. Добавьте атрибут data-dd со значением 3
// элементу у которого существует атрибут
//  "aria-labelledby" равный "dropdownMenuButton"
// используя dataset.
